...
const Internal = ()  =>{
    return(
        ...
        <p>
Rc. No.:- 1156989/ESE53-BG0BGIM/1/2020-ACCD, Date: – 31/12/2020<br></br><br></br>
...
Ref: – 57th Board of Governors Minutes, Dt. 01-07-2020.<br></br><br></br>

The 57th Board of Governors Meeting of APREI Society was held on 1st July 2020 under the Chairmanship of the Hon’ble Minister for Education. The Board of Governors ratified the items from Sl. No. 1 to 12 and resolved the proposals from the item No. 13 to 35<br></br><br></br>

The Item No. 25 is agreed by the Board of Governors for setting up of Internal Committee to avoid misconduct/misbehavior and harassment of Girl students and lady staff.<br></br><br></br>

Therefore, the following Internal Committee is constituted in all A.P. Residential Institutions in the state go curb the misconduct/misbehavior and harassment of girl students and lady staff.<br></br><br></br>

<center style={{fontWeight:"bold" , color:"#243763"}}>CONSTITUTION OF INTERNAL COMPLIANTS COMMITTEE<br></br>
(The Committee Consists of 4 members)</center><br></br>

1. A Presiding officer who shall be a woman employee at senior level at work place from amongst the employees.<br></br>
2. Not less than TWO members from amongst the employees preferably committed to the cases of the women or who have had experience in Social Work or having legal knowledge.<br></br>
3. One member amongst Parents Association/ALUMNI/Local Leaders committed to the case of women or a person familiar with the issues relating to sexual harassment. (50% of the members so nominated shall be women)  The working rules for Internal Complaints Committee is appended to this proceedings for taking necessary action.<br></br><br></br>

Therefore, all the Principals of APR Institutions in the state are requested to constitute the above committee in their institutions immediately and report compliance immediately.<br></br><br></br>

<span>Sri R Narasimha Rao<br></br>
SECRETARY</span><br></br><br></br>

To:<br></br>
All the Principals of Residential Institutions in the state<br></br>
with instructions to communicate the proceedings to<br></br>
all the staff, students of their institutions for<br></br>
information.<br></br>
Copy to<br></br>
The Regional Deputy Secretaries of Andhra and<br></br>
Rayalaseema region.<br></br>
All the District Convenors in the State.<br></br>
All the Sections of the APREI Society Office.<br></br>

 
<br></br><br></br>
<h2><center>ANDHRA PRADESH RESIDENTIAL EDUCATIONAL INSTITUTIONS SOCIETY® , GUNTUR
WORKING RULES FOR INTERNAL COMPLAINTS COMMITTEE</center></h2><br></br>
In pursuance of the Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act 2013 and the Rules framed there under, the Institute hereby adopts the following procedure for determining complaints filed to the Internal Complaints Committee (ICC) constituted under the Act. The procedure complies with the basic principles of natural justice and fair play and has to be adhered to in all complaints, though, in individual complaints, for reasons to be stated in writing, the ICC reserves the right to make exceptions to the procedure stated hereunder.<br></br><br></br>
...
<br></br><br></br>
a. A written apology<br></br>
b. Warning<br></br>
c. Reprimand or censure<br></br>
d. Withholding of promotion<br></br>
e. Withholding of pay rise or increments<br></br>
f. Undergoing a counseling session<br></br>
g. Carrying out of community service<br></br>
h. Terminating the respondent from service<br></br>
...
<br></br><br></br>
i. Summoning and enforcing the attendance of any person related to the incident.<br></br>
ii. Requiring the discovery and production of any documents<br></br>
iii.Any other matter relating to the incident as decided by the Committee from time to time.<br></br>
<br></br><br></br>
