   ...
   const [load , setLoad] = useState(false);
    ...
    return(
        ...
        <div className='findAPRDC'>
            ...
            <center><h2>{data.fname}</h2></center>
            <p>Student ID: <b>{data['hallnumber']}</b></p>
            <p>Branch: <b>{data['branch']}</b></p>
            <p>Year of Passing: <b>{data['yearofpass']}</b></p>
            {data.designation ? <p>Designation: <b>{data['designation']}</b></p>:''}
