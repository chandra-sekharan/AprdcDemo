...
const Header =()=>{
    ...
    const Campus = [{id:"Library",name:"Library",},{id:"NCC",name:"NCC",},{id:"NSS",name:"NSS",},{id:"Placement-Cell",name:"Placement Cell",},{id:"Laboratories",name:"Laboratories"},{id:"infrastructure",name:"Infrastructure"}];
            ...
            <div className="menucontainer">
               <div className="menucontent">
                <ul>
                    ...
                    <li onClick={()=>sub(About)}>About</li><br></br>
                </ul>
                </div>
             ...
             <div className="footer">   
                    <li>Quick Links</li>
                    <li onClick={()=>close()}><Link to="/find" style={{ color: 'inherit', textDecoration: 'inherit'}}>Find</Link></li>
